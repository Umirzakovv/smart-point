...
export const products: Product[] = [
  {
    ...
    description:
      'Experience the ultimate in air purification for larger rooms up to 60m², removing 99.97% of airborne particles. Smart control and OLED display ensure your home remains a sanctuary of health.',
    originalPrice: 229,
    discountPrice: 209,
    highlights: [
  ...
  },
  {
    ...
    description:
      'Compact elegance meets powerful performance, delivering 6,330 liters of purified air per minute. Ideal for bedrooms, its antibacterial filter ensures whisper-quiet, clean air.',
    originalPrice: 189,
    discountPrice: 149,
    highlights: [
  ...
  },
  {
    ...
    description:
      'Achieve the perfect shave with dual-track foils and ceramic blades that adapt to your facial contours. Smart speed control and IPX7 waterproofing make grooming effortless.',
    originalPrice: 39,
    discountPrice: 33,
    highlights: [
  ...
  },
  {
    ...
    description:
      'Grooming made simple and safe with a hypoallergenic, dual-edge blade system. Compact, waterproof, and easy to clean—your perfect travel companion.',
    originalPrice: 25,
    discountPrice: 21,
    highlights: [
  ...
  },
  {
    ...
    description:
      'Salon-quality drying in a portable package with negative ion technology to reduce frizz. Foldable handle and two air modes make it perfect for travel.',
    originalPrice: 22,
    highlights: [
  ...
  },
  {
    ...
    description:
      'Immerse yourself in high-fidelity sound with LDAC support and industry-leading 52dB active noise cancellation. Enjoy up to 38 hours of battery life with the charging case.',
    originalPrice: 59,
    highlights: [
